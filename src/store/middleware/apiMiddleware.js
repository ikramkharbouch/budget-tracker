...
// Save to API when onboarding is completed
  ...
  effect: async (action, listenerApi) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Set user ID if it was generated by the backend
...
// Auto-save progress (optional - for partial saves)
apiMiddleware.startListening({
  ...
  effect: async (action, listenerApi) => {
    ...
    // Only save if user has made significant progress
...
// Utility function to generate a temporary user ID
