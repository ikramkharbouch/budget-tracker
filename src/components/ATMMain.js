...
import NavigationArrows from "./layout/NavigationArrows";
import FormDetailsPhase from "./forms/FormDetailsPhase";
import BudgetPlanningPhase from "./onboarding/BudgetPlanningPhase";
import IncomeDetailsPhase from "./onboarding/IncomeDetailsPhase";
import GoalSettingPhase from "./goals/GoalSettingPhase";
import GoalTrackingPhase from "./goals/GoalTrackingPhase";
import SimulateOneYearPhase from "./onboarding/SimulateOneYearPhase";
import SummaryPhase from "./onboarding/SummaryPhase";
